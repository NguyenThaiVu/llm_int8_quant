...
def measure_power(func, *args, n_iterations=1_000, unit='J'):
    """
    ...
    *args: Arguments to pass to the function.
    ...
    unit (str): The unit of the energy measurement. 
    ...
    if unit not in ['J', 'mJ']:
        raise ValueError("Unit must be 'J' for Joules or 'mJ' for millijoules.")
    ...
    energy_per_op = total_energy / n_iterations  # Energy per operation in Joules
    ...
    if unit == 'J':
        print(f"  {'Energy / operation':<28} {energy_per_op:>15.4f} J")
    elif unit == 'mJ':
